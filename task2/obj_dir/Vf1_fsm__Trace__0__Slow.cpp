...
VL_ATTR_COLD void Vf1_fsm___024root__trace_full_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullCData(oldp+1,(vlSelf->lfsr__DOT__out),8);
    bufp->fullIData(oldp+2,(vlSelf->lfsr__DOT__current_state),32);
    bufp->fullIData(oldp+3,(vlSelf->lfsr__DOT__next_state),32);
